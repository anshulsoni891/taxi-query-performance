-- Benchmark Q5 (Optimized): High Passenger Count, Long Distance, Low Tip Anomaly Trips
-- Optimization Applied: Composite Index on (passenger_count, trip_distance, tip_amount).
-- Plan Shift: Seq Scan -> Index Scan filtering >99% of non-matching rows instantly.
